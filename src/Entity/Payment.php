...
abstract class Payment
{
    ...
    protected $status;
    protected $montant;
    protected $order;  // de type object de la classe order
    ...
    public function setOrder($order)
    {
        ...
        if (!($order instanceof Order) && is_null($order->id)) {
            throw new ValidationException("l'objet order passé au payment non valide!!");
        }
